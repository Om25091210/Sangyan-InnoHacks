...
public class urgent_data extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_urgent_data2, container, false);
    ...
    private void filter_by_district(String type) {
        ...
        phone_numbers_ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Log.e("phone_numbers size= ",phone_numbers.size()+"");
                Log.e("case data list filter size= ",case_data_list_filter.size()+"");
