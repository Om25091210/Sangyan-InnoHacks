...
@Obfuscate
public class Mcrc_Rm_Return extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_mcrc__rm__return, container, false);
    ...
    private void gather_number(String type) {
        dialog1 = new Dialog(getContextNullSafety());
